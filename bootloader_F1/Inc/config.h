...
#define __CONFIG_H
	...
	#define LED1_CLOCK		RCC_APB2ENR_IOPAEN
	#define LED1_BIT_0		//CLEAR_BIT(GPIOA->CRL, GPIO_CRL_CNF1_0)
	#define LED1_BIT_1		//CLEAR_BIT(GPIOA->CRL, GPIO_CRL_CNF1_1)
	#define LED1_MODE		SET_BIT(GPIOA->CRL, GPIO_CRL_MODE1)
	#define LED1_ON			WRITE_REG(GPIOA->BSRR, GPIO_BSRR_BS2)
	#define LED1_OFF		WRITE_REG(GPIOA->BRR, GPIO_BRR_BR2)
